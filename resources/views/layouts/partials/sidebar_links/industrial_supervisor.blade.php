        ...
        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 bg-blue-500 divide-y space-y-1">
                <ul class="space-y-2 pb-2">
                    ...
                    <li>
                        <a href="{{ route('indur.student.calender') }}"  class="text-base text-white font-normal rounded-lg hover:bg-gray-100 hover:text-gray-900 flex items-center p-2 group ">
                            ...
                            <span class="ml-3 flex-1 whitespace-nowrap">Attachment Details hhh</span>
